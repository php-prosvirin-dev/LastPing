...
class ProfileUpdateRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'settings.notifications.siblings.*.name.required' => __('Each emergency contact must have a name.'),

            'settings.notifications.siblings.*.email.required' => __('Each emergency contact must have an email address.'),

            'settings.notifications.siblings.*.email.email' => __('One of the emergency contact emails is not valid.'),

            'settings.notifications.subject.max' => __('Notification subject is too long.'),

            'settings.notifications.message.max' => __('Notification message is too long.'),

            'settings.data_handling.required' => __('Data handling settings are required.'),

            'settings.data_handling.purge_method.required' => __('Please choose how your data should be handled.'),

            'settings.data_handling.purge_method.in' => __('Selected data handling method is invalid.'),

            'settings.data_handling.delay_minutes.required' => __('Please set a data purge delay.'),

            'settings.data_handling.delay_minutes.min' => __('Purge delay cannot be negative.'),

            'settings.data_handling.delay_minutes.max' => __('Purge delay is too large.'),
        ];
    }
}
